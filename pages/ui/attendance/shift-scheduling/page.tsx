        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
          <Card className="md:col-span-1 dark:bg-gray-800">
            ...
            <CardContent>
              ...
              <div className="mt-4">
                <div className="bg-white dark:bg-gray-800 p-2 rounded-t-md flex items-center justify-between border border-gray-200 dark:border-gray-700">
                  <span className="flex items-center font-medium text-gray-900 dark:text-gray-100">
                    <CalendarIcon className="h-4 w-4 mr-2" />
                    Government Holidays
                  </span>
                  <Button variant="outline" size="sm" className="h-7 hover:bg-gray-100" onClick={toggleHolidayList}>
              ...
              <Tabs defaultValue="calendar" onValueChange={setActiveTab} value={activeTab}>
                ...
                <TabsContent value="list" className="mt-0">
                  <div className="space-y-4">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-md border border-gray-200 dark:border-gray-700 mb-4">
                      <div className="text-sm font-bold mb-3 flex items-center text-gray-900 dark:text-gray-100">
                        <svg
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        {filterEmployee !== "all" && (
                          <div className="bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 text-sm px-3 py-1 rounded-full flex items-center font-medium">
                            <span className="mr-1">
