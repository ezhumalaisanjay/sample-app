...
export default function addNotificationToCenter(notification: Notification): void {
  ...
  const mockUsers: User[] = [
    {
      ...
      email: "john@example.com",
      role: "employee",
      notificationPreferences: { notificationTypes: [], frequency: "immediate" },
    },
    {
      id: "2",
      name: "Jane Smith",
      email: "jane@example.com",
      role: "manager",
      notificationPreferences: { notificationTypes: [], frequency: "daily_digest" },
    },
    {
      id: "3",
      name: "HR Team",
    ...
    },
    {
      ...
      email: "it@example.com",
      role: "it",
      notificationPreferences: { notificationTypes: [], frequency: "weekly_digest" },
    },
  ]
...
export async function processEventAndNotify(event: Event, trigger: Trigger): Promise<void> {
  ...
  const immediateRecipients = recipients.filter((user) => shouldSendImmediately(user.notificationPreferences))
  ...
  const digestRecipients = recipients.filter((user) => !shouldSendImmediately(user.notificationPreferences))
